...
std::vector<glm::vec2> cellMidpoints(int columns, int rows, const glm::vec4 & viewport);
glm::vec2 cellScale(int columns, int rows, const glm::vec4 & viewport
    , int width, int height, float padding);
